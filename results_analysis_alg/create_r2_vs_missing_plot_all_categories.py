...
plt.title('Average R² vs Missing Data Percentage by Category', fontsize=15, fontweight='bold', pad=20)
plt.grid(True, alpha=0.3)
plt.tight_layout(pad=2.0)
plt.savefig('results/regression/combined/r2_vs_missing_percentage_all_categories.png', dpi=300, bbox_inches='tight', pad_inches=0.5)
plt.show() 