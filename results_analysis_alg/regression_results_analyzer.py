...
class RegressionResultsAnalyzer:
                ...
                try:
                    ...
                    for exp in experiments:
                        ...
                        record = {
                            ...
                            'std_test_r2': exp.get('std_scores', {}).get('test_r2', np.nan),
                            'test_mse': exp.get('mean_scores', {}).get('test_mse', np.nan),
                            'std_test_mse': exp.get('std_scores', {}).get('test_mse', np.nan),
                            'test_mae': exp.get('mean_scores', {}).get('test_mae', np.nan),
                            'std_test_mae': exp.get('std_scores', {}).get('test_mae', np.nan),
    ...
    def create_top_combinations_overall(self, top_n: int = 20, dataset: str = None) -> pd.DataFrame:
        ...
        result = top_combinations[[
            ...
            'model', 'combination', 'test_r2', 'std_test_r2', 'test_mse', 'std_test_mse',
            'test_mae', 'std_test_mae', 'fit_time', 'std_fit_time', 'n_features', 'n_samples'
        ]].copy()
        ...
        result = result[['rank', 'dataset', 'missing_pct_display', 'algorithm', 
                        'fusion_method', 'model', 'combination', 'test_r2', 'std_test_r2',
                        'test_mse', 'std_test_mse', 'test_mae', 'std_test_mae', 
    ...
    def create_worst_combinations_by_missing_pct(self, worst_n: int = 50, dataset: str = None) -> Dict[int, pd.DataFrame]:
        ...
        for missing_pct in sorted(data['missing_pct_display'].unique()):
            ...
            result = worst_combinations[[
                ...
                'test_r2', 'std_test_r2', 'test_mse', 'std_test_mse', 'test_mae', 'std_test_mae',
                'fit_time', 'std_fit_time', 'n_features', 'n_samples'
            ]].copy()
