...
def create_mcc_vs_fit_time_plot():
    """Create scatter plot of MCC vs fit_time for top 20 classification combinations."""
    ...
    scatter = plt.scatter(top_20['fit_time'], top_20['test_mcc'], 
    ...
    plt.title('Top 20 Classification Combinations: MCC vs Average Fit Time', 
    ...
    output_file = 'results/classification/combined/mcc_vs_fit_time_top20.png'
